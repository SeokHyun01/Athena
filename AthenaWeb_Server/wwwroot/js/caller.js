...
async function sendOffer() {
    ...
    caller.peerConnection.setLocalDescription(offer);
...
async function sendAnswer(offer) {
    ...
    caller.peerConnection.setRemoteDescription(receivedOffer);
    console.log("Receive offer");

    const answer = await caller.peerConnection.createAnswer();
    caller.peerConnection.setLocalDescription(answer);
...
function receiveAnswer(answer) {
    ...
    caller.peerConnection.setRemoteDescription(receivedAnswer);
    console.log("Receive answer");
}

function receiveIce(ice) {
    const receivedIce = JSON.parse(ice);
    caller.peerConnection.addIceCandidate(receivedIce);
